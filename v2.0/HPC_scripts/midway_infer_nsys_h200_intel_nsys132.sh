...
#SBATCH -o midway_infer_nsys_nsys132_noworkers_%N_%j.out
#SBATCH -e midway_infer_nsys_nsys132_noworkers_%N_%j.err
...
NSYS_OUT="${SLURM_SUBMIT_DIR}/midway_h200_intel_4gpus_inference_nsys132_noworkers_${SLURM_JOB_ID}"

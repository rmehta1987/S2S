...
# File-swap diagnostic sibling of midway_infer_nsys_h200_amd.sh.
#
# Purpose:
...
#
# --run_num="infer_nsys_h200_amd" matches the existing production AMD
# script so the same existing checkpoint at
#   results/S2S/infer_nsys_h200_amd/training_checkpoints/ckpt.tar
...
echo "=== midway_infer_nsys_newinfer H200 AMD EPYC: $(date -Iseconds) ==="
...
NSYS_OUT="${SLURM_SUBMIT_DIR}/midway_h200_amd_4gpus_inference_newinfer_${SLURM_JOB_ID}"

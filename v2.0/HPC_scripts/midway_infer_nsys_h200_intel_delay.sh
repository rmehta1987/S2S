...
#SBATCH -o midway_infer_nsys_delay_noworkers_%N_%j.out
#SBATCH -e midway_infer_nsys_delay_noworkers_%N_%j.err
...
NSYS_OUT="${SLURM_SUBMIT_DIR}/midway_h200_intel_4gpus_inference_delay_noworkers_${SLURM_JOB_ID}"
